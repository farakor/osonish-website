            ...
            <div className="relative backdrop-blur-2xl bg-gradient-to-br from-white/30 via-white/20 to-white/10 rounded-3xl p-8 md:p-10 shadow-2xl border border-white/40 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 text-gray-900 leading-tight drop-shadow-sm">
                  Oson Ish в вашем кармане
                </h2>
                
                <p className="text-lg md:text-xl text-gray-800 mb-8 leading-relaxed drop-shadow-sm">
                  Находите работу или исполнителей в несколько кликов. 
                  Управляйте заказами, общайтесь с клиентами и зарабатывайте — 
                ...
                <div className="space-y-4 mb-10">
                  <div className="flex items-center gap-3 text-left backdrop-blur-sm bg-white/20 rounded-2xl p-3 border border-white/30">
                    ...
                    <div>
                      <div className="font-bold text-gray-900">Быстрый поиск</div>
                      <div className="text-sm text-gray-800">Находите работу за считанные секунды</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 text-left backdrop-blur-sm bg-white/20 rounded-2xl p-3 border border-white/30">
                    <div className="flex-shrink-0 w-10 h-10 bg-white/40 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/40">
                    ...
                    <div>
                      <div className="font-bold text-gray-900">Безопасные сделки</div>
                      <div className="text-sm text-gray-800">Система рейтингов и отзывов</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-3 text-left backdrop-blur-sm bg-white/20 rounded-2xl p-3 border border-white/30">
                    <div className="flex-shrink-0 w-10 h-10 bg-white/40 backdrop-blur-sm rounded-xl flex items-center justify-center border border-white/40">
                    ...
                    <div>
                      <div className="font-bold text-gray-900">Проверенные профили</div>
                      <div className="text-sm text-gray-800">Работайте с надёжными людьми</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4">
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-xs opacity-80 leading-tight">Доступно в</div>
                  ...
                  >
                    ...
                    <div className="text-left">
                      <div className="text-xs opacity-80 leading-tight">Загрузить в</div>
